        ...
        if (existingAdmin) {
            ...
            if (existingAccount) {
                ...
                if (!passwordMatch) {
                    ...
                    await accountsCollection.updateOne({ id: existingAccount.id }, { $set: { password: newHash, updatedAt: new Date() } });
            ...
            if (existingAdmin.role !== "admin") {
                await usersCollection.updateOne({ id: existingAdmin.id }, { $set: { role: "admin", updatedAt: new Date() } });
